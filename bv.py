...
'''
project: download the vedio from b,you will see!
version: no cookie,download the 1080P directly,used the encrypt  api
'''
...
def bv_to_av(bv):
    ...
    try:
        ...
        return 'its failed which get the av code'
...
def batch_download(url_link):
    start_time = time.time()
    # 用户输入av号或者视频链接地址
    #print('*' * 10 + 'thanks,my wx:hongzhaoyuanma,secret code:bilibili' + '*' * 10)
